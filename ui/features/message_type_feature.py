...
from PySide6.QtWidgets import QLabel, QRadioButton, QButtonGroup, QVBoxLayout, QWidget, QMessageBox
...
class MessageTypeFeature:
    ...
    def validate(self):
        # Ici, au moins un des boutons radio doit être coché, mais c’est déjà assuré.
        return True

    def save_configuration(self):
        message_type = 'normal' if self.normal_message_radio.isChecked() else 'chatgpt'
